...
async function main() {
  ...
  // Send to first 50 (safe batch)
  const batchSize = 100;
  const batch = contacts.slice(50, 50 + batchSize);
  
  console.log('Sending to first', batchSize, 'contacts...\n');
  ...
  console.log('Remaining:', contacts.length - batchSize);
  console.log('========================================');
}
