...
### Confirmed Rules
*No rules yet - will be populated from corrections*

---

## Layer 2: CONTEXT MEMORY (project/domain-specific)
Rules that apply to specific projects or domains.

### Current Projects
- **Georgia Churches Email Campaign**: Five-Fold webinar promotion
- **EC DUI Portal**: Client project awaiting feedback
- **Five-Fold Outreach**: Email campaign active

### Domain Rules
- **Email Outreach**: Use Gmail Workspace (david@kingdomlife.site) for sending
- **Browser Automation**: Cannot automate social media signups (anti-bot protections)
